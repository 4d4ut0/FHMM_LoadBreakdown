...
class CombinatorialOptimisation(Disaggregator):
    ...
    def train(self, metergroup, num_states_dict=None, **load_kwargs):
        ...
        * only uses first chunk for each meter (TODO: handle all chunks).
        ...
        for i, meter in enumerate(metergroup.submeters().meters):
            ...
            print("POWER SERIES", power_series)
    ...
    def train_on_chunk(self, chunk, meter, max_num_clusters, num_on_states):
        ...
        if meter in meters_in_model:
            raise RuntimeError(
                ...
                .format(meter))
        print("chunk:::: ", chunk)
        print("max_num_clusters:::: ", max_num_clusters)
        print("num_on_states:::: ", num_on_states)


        ##############    LINHA SUUUUUUUUUPER IMPORTANTE!!!!!!!!!!!     ###############################
        states = cluster(chunk, max_num_clusters, num_on_states)
        print("STATESSSSSSSS: ", states)
        self.model.append({
            'states': states,
    ...
    def _set_state_combinations_if_necessary(self):
        ...
        if (self.state_combinations is None or
            ...
            print("self.modellllllllllllll: ", self.model)
            print("CENTROIDS: ", centroids)

            ###$$$$$$$$$$$$$$$$$$$ COMBINACOES OTIMIZADAS $$$$$$$$$$$############
            self.state_combinations = cartesian(centroids)
            print("states_combinationssssss: ", self.state_combinations)
    ...
    def disaggregate(self, mains, output_datastore,**load_kwargs):
        ...
        **load_kwargs : key word arguments
        ...
        for chunk in mains.power_series(**load_kwargs):
            ...
            print("appliance_powers:::::::::",appliance_powers)
    ...
    def disaggregate_chunk(self, mains):
        ...
        state_combinations = self.state_combinations
        print("DISAGGREGATE state_combinations", state_combinations)

        summed_power_of_each_combination = np.sum(state_combinations, axis=1)
        print("DISAGGREGATE summed_power_of_each_combination", summed_power_of_each_combination)
        ...
        #####O índice indica qual eh o aparelho ligado, a ordem indica a posição no conjunto de possibilidades,
        ##Ou seja, se é número 3 significa que é a quarta posição! onde só o microndas 47 de gasto ta ligado.
        ##A potencia residual é o valor da diferença do main pra soma da posição na tabela, é a menor diferença encontrada
        ##find_nearest encontra o valor mais próximo da potência somada.
        indices_of_state_combinations, residual_power = find_nearest(
            summed_power_of_each_combination, mains.values)

        print("DISAGGREGATE mains.values", mains.values)
        print("DISAGGREGATE indices_of_state_combinations", indices_of_state_combinations)
        print("DISAGGREGATE residual_power", residual_power)
        ...
        print("DISAGGREGATE:  APPLIANCE POWERS::: ", appliance_powers)
