...
public class DiarioFragment extends Fragment {
    ...
    private String urlInicial = "http://nexsolar.sytes.net/chesp/api/consumo/";
    private String api = "/diario/";
    private String urlDevice = "http://nexsolar.sytes.net/chesp/api/estacao/usuario/";
    ...
    public static DiarioFragment newInstance(String param1, String param2, String param3, String param4) {
    ...
    public ArrayList<Consumo> getConsumo(String estacaoId, String data){
        try {
            Log.v("url", urlInicial + estacaoId + api + data);
            ...
            public void run() {
                try  {
                    ...
                    if(respsConsumos != null) {
                        ...
                        series.setColor(Color.argb(255, 169, 112, 25));
                        series.setBackgroundColor(Color.argb(100, 238, 218, 131));
