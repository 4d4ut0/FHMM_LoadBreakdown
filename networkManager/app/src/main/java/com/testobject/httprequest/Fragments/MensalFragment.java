 ...
 * Use the {@link MensalFragment#newInstance} factory method to
...
public class MensalFragment extends Fragment {
    ...
    private String api = "/grafico-mensal/";
    ...
    public MensalFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static MensalFragment newInstance(String param1, String param2, String param3, String param4) {
        MensalFragment fragment = new MensalFragment();
            ...
            public void onClick(View v) {
                DatePickerDialog monthDatePickerDialog = new DatePickerDialog(getActivity(),
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        txtData.setText(String.format("%02d/%04d", (month + 1), year));
                    }
    ...
    public void declaration(LayoutInflater inflater, ViewGroup container){
        ...
        txtData.setText(month+"/"+year);
        //txtData.setText("04/2011");
